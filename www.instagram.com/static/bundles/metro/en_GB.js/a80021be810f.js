...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    (e.strs = [
      ...
      "am",
      "Open Media Gallery",
      "If you believe that this content shouldn't have been removed, you may file an appeal by filling in {appeal form link}",
      "Your name or your organisation's name",
      "Removed on {date}.",
      ...
      "Send",
      "Open",
      "I believe that this account violates Instagram's community guidelines",
      "Write a caption...",
      "Filled physical address circle tick",
      "Community",
      ...
      "Former full names",
      "You have previously logged in to {application name} with Facebook.",
      "Using data",
      "We've removed the video that you posted at {time of day} on {date} because it included the following content:",
      ...
      "Outlined tick icon",
      "Toggle audio",
      'Enter the key in your authentication app to link it to Instagram. If your app requires an account name, title it "Instagram" so that it\'s easy to find.',
      "We were unable to send you a login link. Visit the Instagram Help Centre for more information on how to access your account.",
      "They will now be able to request to follow you on Instagram. Instagram won't let them know that you unblocked them.",
      ...
      "Cancel",
      "If you have permission to share everything in the video including the audio, such as the soundtrack or music, you can appeal the removal and have your video reposted. Remember that people should only post videos that they have the right to share. Posting content you don't own may result in action being taken against your account.",
      ...
      "Learn more",
      "Protecting your privacy is our top priority, and we're constantly working to prevent issues like this. We're very sorry that this happened. Thank you for participating in the Android beta programme and for your help improving the Instagram app for everyone. If you have any questions, please contact us at {email}.",
      "Learn more",
      ...
      "Circle tick icon on successful PIN creation page",
      "Activities",
      ...
      "For your security, confirm the code for {cardName} that you used on Facebook. All of your saved payment methods will be available for this and future Facebook Pay payments.",
      ...
      "Removing the application should provide you with the break you're looking for. All of your photos and profile data will still be saved, but you will no longer receive push notifications, then you can come back to your account when you like by re-installing Instagram.",
      "See location",
      "By signing up, you agree to our {=Terms} & {=Privacy Policy}.",
      "change your email address or send the confirmation again",
      "Harassment or bullying",
      "You can continue using Instagram or Facebook to log in to other apps and websites",
      "Done",
      ...
      "These are the apps and websites you've removed from your account. This means that they may still have access to information you've previously shared, but can't make additional requests for private information.",
      "Instagram",
      ...
      "Select all",
      "Back",
      "For your security, please log in to your PayPal account. By doing so, you'll authorise Facebook Pay to use your saved payment info for this and future payments on Instagram.",
      "Top accounts",
      ...
      "Get more help",
      "Apps and websites",
      "Instagram is better in the app",
      "Done",
      ...
      "Video upload failed.",
      "Vignette",
      "If you pay Income Tax above the basic rate and wish to receive additional tax relief, you must include all of your Gift Aid donations on your Self Assessment tax return or ask HMRC to adjust your tax code.",
      "Get the app to share your first photo or video.",
      "Log Out",
      "Not {username}?",
      "• Receive information about your activity from apps and websites to help personalise content, serve relevant ads and provide a safer experience",
      "Before you can make this donation, we need to confirm some information. This helps us protect you from unauthorised payments.",
      "Directories",
      "Ads that you've interacted with",
      "If you leave now, you will lose any changes that you've made.",
      "Animated tick",
      "Back to Login",
      "Locations",
      "Get Started",
      ...
      "You need to finish reviewing these data settings to continue using Instagram. Are you sure that you want to leave?",
      "Select",
      "Blog",
      ...
      "You can now create and share posts directly from your computer.",
      "If you think that someone is in immediate danger, call the emergency services.",
      "th",
      "Post",
      "Confirm your email address to get into Instagram",
      "Continue",
      "• The cookies and similar technologies we use help apps and websites share information about you with Instagram. We use this information to personalise your experience, including the ads that you see, and help businesses analyse and measure ad performance.",
      "Apps and websites",
      "Nudity or pornography",
      "Profile photo removed.",
      "Including alcohol, tobacco, weight loss products or cosmetic procedures",
      "Where your video will appear",
      "The Facebook Audience Network is a way for advertisers to show you ads in apps and websites off the {Facebook Company Products}. One of the ways in which the Audience Network shows relevant ads is by using your ad preferences to determine which ads you may be interested in seeing. You can control this in your {ad settings}.",
      "For supporting or appreciating a brand, celebrity or organisation",
      "Active yesterday",
      ...
      "Press Cmd+C to copy.",
      "Search history",
      "There was a problem while changing your password. Please try again soon.",
      ...
      "File too small",
      "Confirmation code",
      "Are you sure that you want to delete this photo from your story?",
      "report warning icon",
      ...
      "text message",
      "Your photo is blocked in all locations, which means that people won't be able to view, like or comment on it.",
      ...
      "Accept cookies that come from companies other than Instagram, which are used to optimise services including personalising content (including ads), measuring ads, producing analytics and providing a safer experience?",
      "Download app",
      "How do I know if I have permission to use this photo?",
      "Group name",
      "Delete Video",
      "Wed",
      "By submitting a dispute, you give the rights holder, {reference owner name}, permission to review your photo and basic public information about your account. They will have seven days to respond.",
      "Use Instagram with",
      ...
      "Create Account",
      "Go to Profile",
      "Once you've set up your authentication app, copy the 6-digit code it creates, come back to Instagram and enter it on the next screen to finish setting up.",
      "Year:",
      ...
      "Save login info in this browser",
      "View bag",
      "Global business/brand/organisation",
      "If you recognise this device and location, we'll keep your account logged in.",
      "New post",
      "Learn more",
      "Send Confirmation",
      "Post icon",
      ...
      "Cover",
      "Update",
      "We've sent the confirmation code to your email address {email}.",
      ...
      "We use cookies to help provide, personalise and improve your experience, including the ads you see, help businesses with analytics and measuring ad performance, and to provide a safer experience for you. You can learn more about how we use cookies in our {Cookie Policy}.",
      "Enter 3-digit code",
      "Call",
      "I don't like this message",
      "People",
      "We care about your privacy on Instagram, so we wanted to let you know about a technical issue that we recently found and fixed. It impacted certain Instagram accounts, including yours, that were using unreleased versions of Instagram as part of the Instagram Android beta programme.",
      "Confirm",
      ...
      "Description",
      "Done",
      "We've re-sent the confirmation code to your number ending in {phone_number}",
      "Log In",
      ...
      "Cover",
      "Don't close this page until your video has finished uploading.",
      "Drafts",
      "Restricted account",
      "Impersonation",
      ...
      "Accept cookies from Instagram in this browser?",
      ...
      "Sorry, this link doesn't work any more. To reactivate your account, log in with your username and password.",
      "Jan",
      "Sent",
      ...
      "Unfilled physical address circle tick",
      ...
      "There was a problem with deactivating your account. Please try again later.",
      "Manage contacts",
      "Sorry! We're having trouble sending you a verification code at the moment. Please try again later.",
      "July",
      ...
      "You're all set!",
      "Remove",
      "You can disable your account instead of deleting it. This means that your account will be hidden until you reactivate it by logging back in.",
      "See More",
      ...
      "Link {value}",
      "Protecting your privacy is very important to us, and we're constantly working to ensure that issues like this don't occur. We're sorry that this happened. If you have any questions, please contact us at {email}.",
      ...
      "We've detected repeated automated behaviour from your account. Confirm your information using the Instagram app to try to log in.",
      "Spam or scam",
      "Full Name",
      "Use less data",
      "Can't load stickers",
      ...
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want to encourage safety and compliance with local legal restrictions that may apply.",
      "When you request a review, we'll review your comment to determine whether it violates our {communityGuidelinesLink}. All review decisions are final.",
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. Even if you didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      "Loading...",
      "Direct",
      'We work hard to protect the password that you use for your Instagram account. We\'ve recently discovered that when you used the "Download your data" tool, your password may have been displayed in the URL in your web browser once your data was downloaded, as well as being stored in our systems. We have now changed the tool so that this no longer happens, and we are deleting passwords that may have been logged by our internal systems. Nothing that we see suggests that anyone else has used your password. Just to be safe, you may want to update your Instagram password below, as well as anywhere else where you use the same password. You may also want to clear your browser history.',
      "Are you sure that you want to remove yourself from this post?",
      "Save",
      ...
      "Guides",
      "Facebook",
      "If you believe that this content shouldn't have been restricted, you can contact the complaining party directly to resolve your issue.",
      ...
      "One of the ways in which we use cookies is to show you useful and relevant ads on and off Instagram. You can read more about the ways in which we use cookies in our {Cookie Policy}. You also have a number of choices outside your Instagram controls that are described below.",
      "Username",
      "Try It",
      "Authorise",
      "Block",
      ...
      "Following",
      "Two-factor authentication lets you protect your account each time you log in on a phone or computer we don't recognise.",
      ...
      "Saved",
      "When you switch back to a personal account, in-app insights will be turned off and insights from all of your content, including content and insights for promotions, will be permanently removed.",
      "Options",
      ...
      "We have a zero-tolerance policy on threats to post intimate images of others.",
      "Instagram wont tell {Username of current profile} that they were removed from your followers",
      "Leave without resetting your PIN?",
      "Available on Google Play",
      "Your electronic signature",
      "This account couldn't be logged out. Please check your network settings and try again.",
      "Instagram",
      ...
      "User not found.",
      "We care about your privacy, so we wanted to let you know about a technical issue that we recently found and fixed. It impacted certain Instagram accounts, including yours, that were using unreleased versions of Instagram as part of our dogfooding process.",
      "Managing photos of you",
      "Security code",
      "We require a government-issued photo ID that shows your name and date of birth (e.g. driving licence, passport or national identification card) or official business documents (tax return, recent utility bill, article of incorporation) in order to review your request.",
      ...
      "We won't use cookies from other companies to help personalise ads for you off Facebook Products or to measure their performance",
      ...
      "{username} will now see ads which are relevant to more of their interests based on their activity across Facebook Products.",
      "Create username",
      "Learn more",
      ...
      "These are apps and websites you've removed from your account. This means that they may still have information you previously shared, but can't make additional requests. You can ask an app to delete your information. To do it, review its privacy policy for details and contact information. If you contact an app, it may need your user ID.",
      "You can block them directly from their profile. If you do, they won't be able to find your profile, posts or story or send you messages on Instagram. Instagram won't let them know that you've blocked them.",
      "Down Chevron Icon",
      "What was removed",
      "Add to Home screen",
      "Use the app",
      ...
      "Error",
      "Sorry! We're having trouble verifying your verification code at the moment. Please try again later.",
      "We usually let you request a review when you think that your post shouldn't have been removed.",
      "Confirm it's you to log in",
      ...
      "Load more comments",
      "There was an issue while letting the system know that this login wasn't you. Please check your network settings and try again.",
      'To show you more relevant ads, we receive and use data that advertisers and other partners provide to us about your activity on their websites and apps, as well as certain offline interactions, such as purchases. You can control whether you see ads based on your activity off Instagram through "Data about your activity from partners" in your settings.',
      "Former business email addresses",
      "With an invalid email address, we failed to send an email to you.",
      "Network bandwidth",
      ...
      "As you synced your profile photo, your photo will change on both Instagram and Facebook.",
      "Two-factor authentication is on",
      "Choose a reason for hiding this ad:",
      "payment methods, delivery address, name, email address",
      ...
      "Protected payments",
      "learn more about them in our Press Centre.",
      ...
      "If you opt out, we'll only send you emails to help you log in if you request them.",
      "User icon",
      "Blocked commenters",
      "Cancel Gift Aid",
      "For advertising and measurement services off Facebook Products, analytics, and to provide certain features and improve our services for you, we use tools from other companies on Instagram and Facebook. These companies also use cookies.",
      "Stories",
      "You'll enter your PIN as a security check on some payments. To use your PIN for all payments, visit the Facebook Pay settings.",
      "Learn more",
      "Authentication app",
      ...
      "News/media",
      "Report under NetzDG",
      "Other people can add your posts to their stories. Your username will always appear with your post.",
      ...
      "st",
      "Accounts that you've unfollowed",
      "If you're unable to use a login code from an authentication app, you can get one via {=sms code} or use one of your {=backup codes}",
      "Description",
      "{seconds} s",
      ...
      "Unblock",
      "There was a problem while revoking access. Please try again later.",
      "These are apps and websites that you've used Instagram to log in to and have recently used. They can request information that you've chosen to share with them.",
      "Opt out of login help emails",
      "Audio image",
      "down-facing chevron, indicating that the section is closed and can be opened",
      "You have not authorised any applications to access your Instagram account.",
      "IP addresses for non-active sessions",
      "We sent an SMS to {phoneNumber} with a link to get back in to your account.",
      "Leave",
      "{instagramUsername} and {facebookPageName}",
      "See Resources",
      "You're about to temporarily disable your account. Want to go ahead?",
      "Ad preferences",
      "Profile information (required)",
      "Feed",
      "If your appeal is approved",
      "content_removed_img",
      "We've removed your {contentTypeText} because it goes against our {brandedContentPoliciesLink}. Certain goods, services or brands cannot be promoted with branded content, including tobacco products, weapons, ammunition and explosives. In addition, some categories, including social issues, elections or politics, are only allowed in branded content posts if the paying partner has been authorised to run related ads.",
      "Comment options",
      "Sign up",
      "Add your phone number so that you can reset your password, find friends and more.",
      "If you remove your authentication app, you'll only receive security codes by text message.",
      "Done.",
      "Discard post?",
      "Email Removed",
      "Ads",
      ...
      "Go to post",
      "Restricted account",
      "We'll use limited information from other apps and websites for security and integrity purposes, but it will not be used to show you personalised ads",
      "Next",
      "Done",
      ...
      "Seen today",
      "1 year old",
      "Thank you for helping keep the Instagram community safe and fun for everyone. Remember that we don't reveal who submitted reports to the person who posted the photo, video or comment.",
      "• The connection allows the app or website to authenticate your account and receive information that you may choose to share, such as your email address.",
      "View account data",
      "Let us know",
      ...
      "Embed",
      "Block comments from",
      "If you report someone's post, Instagram doesn't tell them who's reported it.",
      ...
      "th",
      "Only people in {story owner username}'s membership can see this story.",
      "You can review or change the information that you share with apps and websites in your {=app and web} settings. These settings are different from the {=privacy} settings that control who can see your content on Instagram.",
      "• The cookies and similar technologies we use help apps and websites share information about you with Instagram and Facebook. We use this information to personalise your experience, including the ads that you see, and help businesses analyse and measure ad performance.",
      "Save",
      "Unmute",
      "Post profile photo?",
      ...
      "Log in",
      "Related accounts",
      "Use the Instagram mobile app to set up affiliate and start earning money.",
      "Update to the latest version of Instagram to see and send messages.",
      "{list of items}, {last item}",
      "Audio is muted.",
      "Preparing video...",
      "Providing your date of birth improves the features and ads that you see and helps us keep the Instagram community safe. You can find your date of birth in your personal information account settings.",
      "No messages",
      ...
      "The video labelled {filename} is too long. To continue, choose a shorter video or post to IGTV instead.",
      "{count} active now",
      ...
      "Circle check icon",
      "Instagram has been a part of Facebook since 2012, and we're making some corporate changes. Moving forwards, our Terms will reflect that Facebook Inc. is responsible for Instagram. The Instagram app and how we process data are not changing.",
      ...
      "You can remove it from this collection or remove it from everything you've saved.",
      ...
      "To help people connect on Instagram, you can choose to have your contacts periodically synced and stored on our servers. You choose which contacts to follow. Disconnect at any time to stop syncing. {learnMoreLink}",
      ...
      "When you use Instagram to log in to other apps and websites, we use cookies and similar technologies to enable the experience and create a secure connection.",
      "Unsend",
      "Credit card's image",
      "Enter Wi-Fi code",
      "Product",
      "Text message",
      "Passport",
      "This link will only work for four days after we've sent it. Because it may contain personal information, make sure that you keep the link private and only download the file to your own computer.",
      ...
      "Learn about brands that you can buy from directly on Instagram.",
      "Full name",
      "days",
      "Filters",
      "Accounts you hide stories from",
      "Follow the next steps to help us get you back in to your account.",
      ...
      "{count} likes",
      "We'll remember your login information for you. You won't need to enter it when you log in again.",
      "Skip",
      ...
      "Terms of Use",
      "Add manually",
      "All monetised videos are reviewed.",
      "Government and politics",
      "Text (SMS) messages",
      "Search icon.",
      "Log out",
      "I am the legal guardian of {username} and am authorised to approve their data choices.",
      "When you log in to an app or website with Instagram:",
      "Guides are only in the app",
      "We'll remember your login information for {username}. You won't need to enter it when you log in again.",
      "Jul",
      "Report",
      "Confirm PIN",
      "There was a problem while sending the email.",
      "See this Instagram guide by @{username}",
      "Enter the last four digits of your social security number (SSN) or individual taxpayer identification number (ITIN).",
      "Confirm",
      "About cookies and similar technologies on other apps and websites",
      "Didn't enter the correct phone number?",
      "Privacy Policy",
      ...
      "shopping basket with circle drawn around it.",
      "Authentication app",
      "No posts yet.",
      "Your story has been removed",
      "Nominate",
      "If you signed up with Facebook, you'll need to {create a password} and log back in.",
      "Log in to {username} to continue. You'll be logged out of {source_account_username}.",
      "When people ask to follow you, you'll see their requests here.",
      "{username} sent a message",
      "Would you like to continue using Facebook to log in?",
      "We couldn't find your account",
      "Business tools",
      "Similar account suggestions",
      "Change your password to continue using Instagram. If you share your new password with one of these services, you may be blocked from following, liking or commenting.",
      "No posts yet",
      ...
      "Media (optional)",
      "{count} follower",
      "The file labelled {filename} is too small. To continue, choose a file larger than 1 KB.",
      "Best for retailers, local businesses, brands, organisations and service providers.",
      "We won't use cookies from other companies to help personalise ads for you off Instagram or measure their performance",
      "Video sound off",
      "Intellectual property violation",
      "Menu",
      "Blocked",
      ...
      "No account found.",
      "{Submit an appeal text bolded} if you still believe that this was a mistake and that you have permission to use this video.",
      "Close",
      "Sending your donation...",
      "Linked to Facebook",
      "In some cases, this includes information that recognised health organisations say could mislead people about how to cure or prevent a disease or that could discourage people from seeking medical treatment.",
      'Instagram complies with the notice and take-down procedures defined in section 512(c) of the Digital Millennium Copyright Act ("DMCA"). While Instagram does not tolerate copyright infringement, we also do not tolerate false claims of infringement. If your content was removed under the notice and counter-notice procedures of the DMCA, and you believe that it was removed as a result of mistake or misidentification, you are able to file a DMCA counter-notification.',
      "Back to Instagram",
      ...
      "Cancel",
      "Video must be between {minDurationInSeconds} seconds and {maxDurationInMinutes} minutes in length.",
      ...
      "Our Terms are now more clear about the service we provide and what we expect from every member of our community to keep Instagram a safe place for everyone. Here are some updates we want to make sure that you know about:",
      ...
      "Get help faster",
      "We want to let you know that we've recently found and fixed a technical issue that impacted a small number of Instagram accounts, including yours.",
      "Write a caption...",
      "Suspicious activity",
      ...
      "Add tag",
      "See Comment",
      "We use spam reports as a signal to understand problems we're having with spam on Instagram. If you think that this post violates our {link_to_instagram_community_guidelines} or {link_to_instagram_terms_of_use} and should be removed, mark it as inappropriate.",
      "Your item has been saved.",
      "Related hashtags",
      "Forgotten your password?",
      "An error has occurred. Please try again later.",
      "Tap to tag people",
      "Pages, groups, profiles and Instagram accounts that repeatedly post false information about COVID-19, vaccines and health might face restrictions, including reduced distribution of their posts, being removed from recommendations and being unpublished or disabled.",
      "Admin records",
      ...
      "Phone number confirmation Page",
      "Switch to the app to see what's in this guide.",
      "{age} years old",
      "See more posts with #{hashtag}",
      "Know straight away when people follow you or like and comment on your photos.",
      "Delete Item",
      "Find more accounts like {name}",
      "You will be able to get back to your account once we've confirmed your identity. {Learn more}",
      "The cover photo must be vertical and in JPG format. An aspect ratio of 9:16 is best.",
      "th",
      "By doing so, you'll authorise Facebook Pay to use your saved payment info for this and future payments on Instagram",
      "See all",
      "Enter {authMethod}",
      ...
      "Unable to upload. One or more file types that you've selected are not supported.",
      ...
      "Live now",
      "Checkout",
      "Provide, personalise and improve content and services for you",
      ...
      "Please click Yes below to confirm that this is your Instagram account. If it isn't your account, please click No to return to the login screen. Then log in to confirm your account.",
      ...
      "You can disconnect your payment info at any time in Facebook Pay. Your Facebook Pay information, including payment methods, delivery address, name, email address and payment history, will only be accessible on Facebook. You'll still see your Instagram orders in Instagram.",
      "{like count} like",
      "Log In With PayPal",
      "Added by {username}",
      ...
      "Each code can only be used once. You can also get new codes if you're worried that this set has been stolen, or if you've already used most of them.",
      "with {username}",
      "Email address",
      "text",
      ...
      "When you log in, you can see all posts that people share about this location.",
      "Due to ownership restrictions, your video has been blocked in some countries, but is fully available in:",
      ...
      "There was a problem while saving your profile. Please try again soon.",
      "You can control whether you see ads based on your activity off Instagram through data about your activity from partners in your settings. If you've enabled connected experiences across your Instagram and Facebook accounts, you can also adjust your Facebook ad experience through this setting.",
      "Categories",
      ...
      "August",
      "Please ensure that no other users or tools have access to your account and that you are following our Terms of Use.",
      "1 w",
      ...
      "There was a problem with declining the tester invitation. Please try again later.",
      "Create an Instagram shop for the product's catalogue to see the effect",
      "Between 13 and 18",
      "Similar accounts",
      ...
      "When you log in, you can see all posts that people share with this hashtag.",
      "You'll now get all password reset emails.",
      "If you are uncertain whether you should file a DMCA counter-notification, we recommend that you seek the advice of a legal professional, ideally one who specialises in intellectual property law. There maybe adverse legal consequences if you submit a false DMCA counter-notification or submit one in bad faith. If you file a false counter-notification, you could be liable for damages and legal fees under section 512(f) of the DMCA, among other things.",
      ...
      "Enter future date",
      "It looks like you've misspelt your email address. Did you mean to use {filled email domain}?",
      "Content that targets people to degrade or shame them",
      "Thanks for reporting this",
      "Log in to view {username}'s profile",
      "We'll remember your cookie choices and apply them anywhere you're logged in to Instagram and where you use your accounts to log in to other Facebook products. You can review or change your choices at any time in your cookie settings.",
      "Browse more posts by logging in",
      "Image for deleted content",
      "Update App",
      "Account data",
      ...
      "Based on the category that you've selected, you may be a creator. You can edit this at any time.",
      "Continue as @{username}",
      "phone number",
      ...
      "We've updated our intellectual property licences, but your rights aren't changing. You still own your photos and videos.",
      "See more...",
      ...
      "Do you want to allow {username} to send you messages from now on? They'll only know that you've seen their request if you accept it.",
      "Hide comments that contain any of the words or phrases you type above from your posts.",
      "Stories are better in the app",
      "Adding Gift Aid to your donation means that for every £1 you give, 25p will be added at no extra cost to you.",
      "Your comment has been removed",
      "For the next {days to snooze} days, you'll only receive login help emails from devices on which you've used Instagram before.",
      "This effect is not available. Please try again later.",
      "Tap to play",
      "Your photo has been blocked because it may contain content that belongs to someone else.",
      "Agree to Terms",
      "Select to remove",
      "Turning comments off",
      "Sorry, there was a problem. Please try again.",
      "We can save your login information on this browser so that you won't need to enter it again.",
      ...
      "Install an app such as Google Authenticator or Duo Mobile, then return to Instagram to finish setting up.",
      "Unblock",
      "Town/city",
      ...
      "Verified accounts have blue ticks next to their names to show that Instagram has confirmed that they're the real presence of the public figures, celebrities and brands they represent.",
      "Confirm PIN",
      ...
      "Notifications are off for messages you move here, but you can turn them on at any time.",
      "Facebook logo",
      "Submit",
      ...
      "Log in",
      "There was a problem while loading your inbox.",
      "Confirm this login?",
      ...
      "More growth tools",
      "Avoid altering the design or printing on dark or patterned colours.",
      "Story icon",
      ...
      "Return to Home",
      "We weren't able to send you a login link.",
      "Shopping bag emails",
      "Think we made a mistake?",
      "• Instagram and Facebook to receive information about your activity from apps and websites to help personalise content, serve relevant ads and provide a safer experience. This information is shared across Instagram and Facebook because you added these accounts to your Accounts Centre",
      "Dismiss",
      "Please confirm that you want to log in to {app name} using the {username} Instagram account",
      "Drug use",
      "Essential cookies",
      "You won't receive messages from this group unless someone adds you to the chat again.",
      ...
      "Choose File",
      "You'll receive a code from your security app.",
      "Create PIN",
      "Removed by {username}",
      "See More",
      "Confirm login?",
      ...
      "View more",
      "Other",
      "We've recently found that your Instagram password had been stored internally in a readable format. We've fixed the issue and found no sign that your stored password has been improperly accessed or abused.",
      "May",
      "OK",
      "Saved collection",
      "Select Crop",
      ...
      "• You can edit the information that {app name} will receive. You may choose to cancel without sharing, but you won't be able to connect Instagram to {app name}.",
      "create a password",
      "{days} days ago",
      ...
      "Your Instagram data",
      "+ {count}",
      "The username that you've entered doesn't belong to an account. Please check your username and try again.",
      ...
      "Report User",
      "Place",
      "We've created our {communityGuidelinesLink} to support and protect our community, and we removed your post because we're concerned that it may encourage self-harm or suicidal behaviour. We understand that this may not be your intention. We care about your safety, and if you're going through something difficult, we'd like to help. We encourage you to get support through our resources.",
      ...
      "Log in",
      "Date of birth",
      "There was a problem while logging out of your account. Please try again later.",
      "Personal information settings",
      "This message is spam or a scam",
      "Full name",
      "This link will only work for the next four days. Because it may contain personal information, make sure that you keep the link private and only download the archive to your own computer.",
      "Do more with stories on Instagram Lite",
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink}. If you post something that goes against our guidelines again, your account may be deleted, including your posts, archive, messages and followers.",
      "You have restricted {username}.",
      "Cancel",
      "The file labelled {filename} could not be uploaded. To continue, choose an mp4 file.",
      ...
      "Facebook",
      "We recently found that your Instagram password was stored internally in a readable format. We've fixed the issue and found no sign that it was improperly accessed or abused by anyone internally. We're very sorry that this happened, and we'll continue to improve how we protect your information.",
      ...
      "The files that you've selected are not supported.",
      "Message not available",
      "Instagram share",
      "If you haven't received it, we can {resendCode}.",
      ...
      "We weren't able to connect your account using the PIN that you entered. You can still connect by logging in to your linked PayPal account.",
      ...
      "View replies",
      "You are eligible to receive Gift Aid if:",
      "by {username}",
      "Tag another person",
      "Most popular",
      "Your feedback is important in helping us keep the Instagram community safe.",
      ...
      "Get the app.",
      "Remember login info",
      "Is {birthday} your date of birth?",
      ...
      "Accounts Centre is only available in our mobile apps. Go to Accounts Centre in the settings of your Instagram, Facebook or Messenger app to manage connected experiences, such as logging in across accounts, and story and post sharing.",
      "Too busy/too distracting",
      "It looks like you requested to delete this account. Learn more in the Help Centre: https://help.instagram.com",
      "Download",
      "Let us know.",
      ...
      "If you have permission to share everything in the video including the audio, such as the soundtrack or music, you can appeal the block and have your video unblocked.",
      "Make Private",
      "Move",
      ...
      "An overview of your privacy information and choices across Instagram, the Facebook app and Messenger, so that you can make sure these settings are right for you.",
      "Off-Facebook activity",
      ...
      "Entity header",
      "You can get new codes if you're worried that this set has been stolen, or if you've used a lot of them.",
      "Keeping your data safe",
      "Sharing...",
      "Sorry! We're having trouble creating your account at the moment. Please try again later.",
      "Filter",
      "You have unseen notifications.",
      "Share Post",
      "The rights holder, {reference owner name}, rejected your dispute because they believe that the photo contains their content.",
      "Update with Facebook",
      "Business",
      "{Submit a dispute text bolded} if you have permission to use all of the content in your photo. By submitting a dispute, you give {owner name}, who has issued this claim, permission to review your photo. They can also review the entire post if you've shared it publicly. They will have {number of days} days to respond.",
      ...
      "{username} won't know that they've been moved. You can move them back to Primary at any time.",
      "Hashtags directory",
      "Suggested profiles",
      "Help",
      "Get Instagram Lite",
      ...
      "Mute messages",
      "Hate speech or symbols",
      "We've recently found, and quickly fixed, a technical issue that affected a small number of Instagram accounts, including yours.",
      ...
      "Rights holder:",
      "Continue",
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want our community to feel respected and safe.",
      "Get a free professional account",
      "Send",
      "Change",
      "Enter county/region",
      "Confirm the Instagram business profile that you want to connect to {applicationName}.",
      "Add your name and bio so that friends can find you.",
      "October",
      "OK",
      "Are you sure?",
      "Not Now",
      ...
      "You'll see all of the people who follow you here.",
      "Allow",
      "Share to WhatsApp",
      "Sport",
      "Privacy concerns",
      ...
      "List all of the names that the person or organisation your account represents is known by. Include different names and the same name in other languages.",
      "Submit Appeal",
      "For the next {days to snooze} days, you'll only receive password reset emails from devices on which you've used Instagram before.",
      "Thanks for letting us know that you did not request a password reset. Your password has not been changed.",
      "By continuing, {=app name} will receive ongoing access to your information and Instagram will record when {=app name} accesses it. {=learn more} about this sharing and the settings that you have.",
      "Quizzes",
      "I don't want to see this account's photos or videos in my feed",
      "Save",
      "You can appeal to the rights holder, {reference owner name}, if you disagree with the outcome of your dispute. Once submitted, they will have seven days to respond.",
      ...
      "You can allow the use of all cookies, or you can choose more options. We'll remember your cookie choices and apply them anywhere you're logged in to Instagram, and where you use your accounts to log in to other Facebook Products. You can review or change your choices at any time in your cookie settings.",
      "Already following {username}? {=Log in} to see their photos and videos.",
      ...
      "When you log in, you can see all of their photos, videos and story updates.",
      "Not Now",
      "copyright",
      "Don't Allow",
      ...
      "For advertising and measurement services off Facebook Products, for analytics and to provide certain features and improve our services for you, we use tools from other companies on Instagram. These companies also use cookies.",
      "You'll receive a code from your security app. If you don't have a security app, we'll recommend one to download.",
      "Connections",
      ...
      "Privacy Policy",
      "Go Back",
      "These are apps and websites you've used Instagram to log in to and may not have used in a while. They may still have information you previously shared, but their ability to make additional requests for private info has expired. You can ask an app to delete your information. To do it, review its privacy policy for details and contact information. If you contact an app, it may need your user ID.",
      "About These Cookies",
      "Turn off commenting",
      "1 ACCOUNT",
      "Accounts Centre",
      "Mail icon",
      "Only you can see your contacts, but Instagram uses the information you've uploaded about your contacts to make friend suggestions for you and others and to provide a better experience for everyone.",
      "Privacy Centre",
      ...
      "Want to continue using this account?",
      ...
      "You",
      "View",
      "They requested videos containing this content to be blocked everywhere except for in the following countries in which they own the rights:",
      "Confirm new PIN",
      ...
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. If you post something that goes against our guidelines again, your account may be deleted, including your posts, archive, messages and followers.",
      "Active now",
      ...
      "Choose size",
      "{count} post",
      "Instagram adheres to the Self-Regulatory Principles for Online Behavioral Advertising and participates in the opt-out programmes established by the {Digital Advertising Alliance}, the {Digital Advertising Alliance of Canada} and the {European Interactive Digital Advertising Alliance}. You can opt out from all participating companies through these sites.",
      "Enter code",
      "Select Zoom",
      "December",
      "Add from saved",
      ...
      "These are apps and websites that you've used Instagram to log in to and may not have used in a while. They may still have access to information that you've previously shared, but their ability to make additional requests for private information has expired.",
      ...
      "Try it out",
      "Make sure that you have permission to use all of the audio in your video before you restore it. If you don't have permission to use this audio, restoring it could result in the removal of your video and further action being taken against your account.",
      "Change Language",
      ...
      "Nametag",
      "Post to IGTV",
      "There was an error while updating your basket.",
      "Approve",
      "All {category name}",
      "Videos must be one hour or less.",
      "Decline All",
      ...
      "Connect your payment info",
      "+ {remainingUserCount}",
      "Stories from people who you follow will appear here.",
      "Get the app to use stickers",
      "Drag photos and videos here",
      "Report a problem with the map",
      "Only people who {story owner username} has added to their close friends list can see this photo.",
      "Are you sure that you want to remove yourself as a tester of {name}",
      ...
      "Comments",
      "This means that we won't be able to review your comment again, though your feedback helps us learn as we build tools to keep our community safe.",
      "IGTV",
      "rd",
      "Change phone number",
      ...
      "Confirm your email address to get back into Instagram",
      "More information",
      "Might be posting my intellectual property without authorisation",
      "New collection",
      "Enter last four digits of SSN",
      "We can use and share information for research, especially in ways that help us keep our community safe on Instagram, such as to understand and prevent bullying and harassment.",
      "Desktop icon",
      "Account privacy",
      "Post",
      "Send",
      ...
      "We need your ID to help confirm who you are. It must show your name, date of birth, photo, the date of issue, expiry date and country of issue.",
      "Share",
      "Photos and videos",
      "Your report will help keep Instagram free from spam.",
      "Visual arts",
      "View all",
      "Comment icon",
      "Your code was sent again.",
      "Close",
      ...
      "Verified",
      "Turn this on?",
      "{username}, we have important information about your Instagram account",
      ...
      "Decline",
      "Enter the code that we sent to your number ending in {lastFourDigits}.",
      "Get new codes",
      "Intellectual property violation",
      ...
      "Log Out",
      "Post has been saved",
      "Dialogue header image",
      "Portrait (9:16)",
      "entering your payment info",
      "We usually review IDs within 24 hours. You'll receive a notification when we have an update.",
      ...
      "Copy link",
      "There was a problem while saving your keywords.",
      "Based on the category that you've selected, you may be a business. You can edit this at any time.",
      "Continue as {fullName}",
      "Your video matches {overlap duration} seconds of video owned by {reference owner name}.",
      "We usually let you request a review when you think that your comment shouldn't have been removed.",
      "Unfollow",
      "Tooltip icon",
      "Not now",
      "Download Instagram Lite",
      "We've recently found and fixed a technical issue and wanted to let you know about it. For a period of time in November, changes to your blocked accounts on Instagram may not have been saved. We've fixed the issue and made sure that accounts you intended to block are blocked. You can visit \"Blocked accounts\" in settings at any time to see who you've blocked on Instagram.",
      "Messenger",
      ...
      "Back to Instagram",
      "Done",
      "To access Instagram, log in now using the phone number, email address or username associated with your Instagram account.",
      "Your billing info and payment method stay private. Your donation and contact info is shared with the organisation.",
      ...
      "Your phone number ending in {This is the last 4 digits of the user's phone number} was added to your account. We'll now ask for a login code each time you log in on a phone or computer we don't recognise.",
      "th",
      "Exclusive story",
      "Creator Studio icon",
      "Leave Chat",
      "You own your photos and videos. Advertising does not change this.",
      ...
      "Sorry, this link doesn't work any more. To keep your account, log in with your username and password.",
      "Search",
      "If you don't want these cookies:",
      "This video doesn't follow the Content Monetisation Policies.",
      "Enter the confirmation code that we sent to {email}.",
      "Post",
      "Tester invitations",
      "Your post could not be shared. Please try again.",
      "The issue affected certain beta testers who had more than one Instagram account logged in on their device. For a few hours between 4 June 2018 and 5 June 2018, it caused some posts or stories published from one account to be posted to another account logged in on the same device. As a precaution, we encourage you to look at your profile and make sure that any posts from 4 June and 5 June were shared from the intended account.",
      "Write alt text…",
      "Checkout in App",
      "SMS has been resent.",
      ...
      "Learn More",
      "terms",
      "Your backup codes can get you back into your account if you're unable to receive a security code via text or authentication app. Make sure that you keep them in a safe place.",
      "Comment filtering",
      "Profile update",
      "Username",
      "Haven't received a security code? We can {=resend it}.",
      "Home",
      "We couldn't connect to Instagram. Make sure that you're connected to the Internet and try again.",
      ...
      "We'll be able to better personalise ads for you off Instagram and measure their performance",
      "Tell Us",
      "Remove from Group",
      "Audio",
      ...
      "These cookies help other companies to share information with us about your activity on their apps and websites. We use the information we receive to help personalise and improve your experience, including the ads you see, help businesses with analytics and measuring ad performance and provide services off Facebook Products, such as using Instagram or Facebook to log in to other apps and websites.",
      "Instagram uses this to make some features work, personalise content, help people find places and more. You can always change this later in your phone's settings.",
      "Declined follow requests",
      "To continue, please re-enter your password",
      "Continue with the account that you used before?",
      ...
      "Connect contacts",
      "Crop",
      "You'll need to enter your username and password next time you log in as {username}",
      "Unblock {username}",
      "Learn more",
      "Block",
      "The group won't know that it's been moved. You can move the group back to Primary at any time.",
      "For a brief time in November, the issue prevented you from changing the privacy setting of your account from public to private. We've fixed the issue, and your account is now private. You can review and edit your followers from your profile to make sure that you are comfortable with the accounts following you.",
      "Filters",
      ...
      "Active 1h ago",
      "To repost your video, please agree:",
      "Remember",
      "Plus icon",
      "How to use hashtags",
      ...
      "If you remove your phone number, you'll only receive security codes from your authentication app.",
      "Liked by {username}",
      "Log In",
      "Help",
      "Add {amount} for free delivery",
      "Known as",
      ...
      "Block",
      "Thursday",
      "Access Instagram quickly and easily by adding it to your home screen.",
      "This file is too large. To continue, choose a file that is 100MB or less.",
      "Video settings",
      "{maxBadgeCount}+",
      "There was a problem with accepting the tester invitation. Please try again later.",
      "Want more IGTV features? Try Creator Studio",
      "Instagram",
      "Message...",
      "Pictures and videos",
      "No file available",
      "We're very sorry that this has happened, and we'll continue to improve how we protect your information. To learn more about changing your password or keeping your account secure, you can {help center link}.",
      "Session updates",
      "Question",
      ...
      "Ad settings",
      "Abusive content",
      "See notifications that you may have missed.",
      "Tap to remove",
      ...
      "Before you temporarily disable your account, you might want to take a look at these articles in our Help Centre.",
      ...
      "Post options",
      "We'll send a code to the number you choose.",
      "Sorry! We're having trouble verifying your email address at the moment. Please try again later.",
      "Upcoming event icon",
      "This video is too long. To continue, choose a video that is one minute or less.",
      "Watch all",
      "Email address confirmation",
      "Skip",
      "You are about to remove {email} from your account. Please make sure that this is correct before proceeding.",
      "Paid partnership",
      ...
      "Forward",
      "Document type",
      "To use less mobile data, photos and videos may appear at a lower resolution when you're off Wi-Fi and videos won't play automatically.",
      "Sep",
      "Edit video",
      "Your friend is on Instagram as {username of the user who joined}",
      "Instagram takes safety seriously. If someone has created an Instagram account pretending to be a celebrity, you can report it to us. Please enter the username of the person being impersonated below.",
      "Here is the file you requested with the information about your account {username}.",
      "Email address",
      "Orders and payments",
      "Please confirm the content that you wish to appeal",
      ...
      "Item unavailable",
      "Details",
      "There was a problem while opening the camera. Please try again.",
      ...
      "99+",
      "Enter PIN",
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. If you post something that goes against our guidelines again, your account will be deleted, including your posts, archive, messages and followers.",
      "Crop square icon",
      "Link expired",
      ...
      "Follow requests",
      "You can manage how different data is used to personalise ads with these tools.",
      "About us",
      "Email address",
      "Next",
      "months",
      ...
      "Tap to Refresh",
      "At Facebook, which builds Instagram, we believe that personalising the content you see improves your experience. We use cookies and similar technologies to show you relevant content and to improve how our products work.",
      ...
      "Videos",
      "Learn More.",
      "We also have a new Data Policy that explains how data is collected, shared and used in the Facebook Products, including Instagram. The policy addresses newer features such as stories, direct messaging, activity status and the creative tools in our cameras. We wanted to make sure that you knew about this new information in the policy.",
      ...
      "If you remove your authentication app, you'll only receive security codes by text message. You can add it again from the Instagram app.",
      "Cancel",
      "{username} said that you were their parent or guardian.",
      "Share Anyway",
      ...
      "Open App",
      "Harassment or bullying",
      "• The app or website will be able to continue accessing the information that you've shared with it. For example, if you allow an editing app to access your photos, the app is able to access new photos that you add to Instagram.",
      "Save",
      "Submit",
      "Alt text",
      "Search categories",
      ...
      "There was a problem while saving your profile.",
      ...
      "+ New Collection",
      "If you believe that this content shouldn't have been removed, you can contact the complaining party directly to resolve your issue.",
      "Admin approval needed",
      "Click and drag to reorder",
      "Former email addresses",
      "See Trusted Devices",
      "Followed by {username1}, {username2} and {username3}",
      "We'll send a code to your phone number ending in {This is the last 4 digits of the user's phone number}.",
      ...
      "Clip",
      "Copy Link",
      "{username}, we care about your privacy on Instagram. So we wanted to let you know that we've recently found, and quickly fixed, a technical issue that affected 124 Instagram accounts, including yours.",
      ...
      "The video labelled {filename} is too long for a gallery post. To continue, choose a shorter video.",
      ...
      "Chats",
      "th",
      "Connection can't be made now. You can connect your payment info from your settings.",
      ...
      "Due to ownership restrictions, your video has been blocked worldwide.",
      "Other companies will receive information about you by using cookies",
      "Sharing",
      "If you have an Instagram account, you can manage how different data is used to personalise ads with these tools.",
      "Go back",
      ...
      "Open App",
      "th",
      "Sorry! We're having trouble sending you a confirmation code at the moment. Please try again later.",
      "Comment",
      "Make Public",
      ...
      "We'll email you a link to a file with your information. You can receive it in HTML format, which may be easier to view, or JSON, which may be easier to import to another service.",
      "Tagged people",
      ...
      "The file labelled {filename} is too large. To continue, choose a file under 1 GB.",
      "Report as inappropriate",
      "Undo",
      "You can now create and share posts directly from your computer.",
      ...
      "Add Gift Aid",
      "Remove",
      "Your account has been temporarily disabled. To reactivate it, log in again.",
      "When you request a review, we'll review your post to determine whether it violates our {communityGuidelinesLink}. All review decisions are final.",
      "Log in to see more",
      "Keyword",
      "Report as violence or a threat of violence?",
      "Phone number",
      "Suggested profiles directory",
      "Next",
      "Block this user?",
      "You followed a link that requires you to be logged in to {username}. You will be logged out of your current account.",
      ...
      "OK",
      "Learn more",
      "People have viewed your video more than {viewcount} times.",
      "Seen {mins}m ago",
      "Report",
      "Add PayPal",
      "Submit an appeal",
      ...
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink}. Even if you didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      "Report as self-injury?",
      "Turning on authentication app is not supported on the web now. Sorry for any inconvenience.",
      ...
      "Enter one of the eight-digit codes provided when you set up two-factor authentication.",
      ...
      "Post",
      "Go to Profile",
      "Your video is blocked in all locations, which means that people can't view, like or comment on it.",
      "Get",
      "Posts of nude or partially nude children",
      "This voluntary survey conducted by the University of Maryland (UMD) asks health questions to track the spread of coronavirus. It'll take 3-5 minutes, and you'll leave Instagram to take it.",
      "Add Facebook Photo",
      ...
      "Get App",
      "There was a problem while giving approval.",
      "ad settings",
      "Authorised by you on",
      ...
      "Appeal",
      "As you said that this wasn't you, update your password to keep your account safe. You'll be logged out everywhere else, so anyone trying to get into your account will no longer have access.",
      "Log in to see photos and videos from your friends.",
      "For advertising and measurement services off Facebook Products, analytics, and to provide certain features and improve our services for you, we use tools from other companies. These companies also use cookies. You can learn more in our Cookie Policies on {Instagram} and {Facebook}.",
      ...
      "Sent. You've finished!",
      "There was a problem with resetting your password. Please try again soon.",
      "Emoji",
      "Some features on our products may not work",
      "Your Instagram account was deactivated as part of an ongoing study. If you continue to log in to your account, you may not be eligible for the deactivation payment that you signed up for.",
      "Want to keep using this account?",
      "If you have permission to share everything in the video including the audio, such as the soundtrack or music, you can appeal the block and have your video unblocked. Remember that people should only post videos that they have the right to share. Posting content you don't own may result in action being taken against your account.",
      "other options",
      "Former links in bio",
      "Shop {name of the product} by {merchant user name} on Instagram",
      "Hashtags",
      "{username} won't know that they've been moved. You can move them back to General at any time.",
      "Disappearing",
      "Privacy and security help",
      "The PIN entered is incorrect. Please try again.",
      "others",
      ...
      "Cookie Policy",
      "Copy link",
      "We'll review your info and, if we can confirm it, you'll be able to request a review in the Help Centre within approximately 24 hours.",
      "We'll remember your cookie choices and apply them anywhere you're logged in to Instagram or Facebook and where you use your accounts to log in to other Facebook products. You can review or change your choices at any time in your cookie settings.",
      "Controls in your Instagram account",
      "Payments Gift Aid",
      "Change privacy?",
      "Last four digits of SSN",
      "You can log in to these accounts because they're in your Accounts Centre.",
      "Get the App",
      "Delete",
      "Update your app",
      ...
      "Upload failed.",
      "Turn on",
      "There was an error while submitting your bug report. Please try again later.",
      "Sign up",
      ...
      "Confirmation code",
      "Please enter a valid email address.",
      "Violence or dangerous organisations guidelines",
      "Your Story",
      "Alternatively, you may submit an appeal by filling in {appeal form link}",
      "More camera effects. More stickers. More ways to message. Only in the app.",
      "No",
      "Get the full experience on Instagram Lite",
      "Seen just now",
      "{Submit an appeal text bolded} if you still believe that this was a mistake and that you have permission to use this photo.",
      "Are you sure that you want to remove this invitation?",
      ...
      "We've updated how we use information to show activity on Instagram, so people can see when you've interacted with an ad in the same way that we do on a regular post.",
      ...
      "The best Instagram experience is in the app.",
      ...
      "Visit",
      "You can allow the use of all cookies, or you can choose more options. We'll remember your cookie choices and apply them anywhere you're logged in to Instagram or Facebook, and where you use your accounts to log in to other Facebook Products. You can review or change your choices at any time in your cookie settings.",
      "{Bold text if your appeal for video is approved}, the original video you shared won't be blocked.",
      "If you allow these cookies:",
      "Browse",
      "You have no sandbox invitations from other applications",
      "Followers",
      "You can remove this video if you aren't sure if you have permission to share any part of it.",
      "Log in",
      "OK",
      "Attach evidence",
      "Community Guidelines",
      "You already have the maximum number of accounts saved. You can manage saved accounts when logged out.",
      "Clear searches that you've made for accounts, locations or hashtags in Explore.",
      "Profile Picture",
      "Switch to the app for better ways to create, share and archive stories.",
      "If you don't recognise this activity, change your password.",
      "Typo?",
      "We use cookies to help provide, personalise and improve your experience, including the ads that you see, help businesses with analytics and measuring ad performance, and provide a safer experience for you. You can learn more about how we use cookies in our Cookie Policies on {Instagram} and {Facebook}.",
      "Primary",
      ...
      "Connect to Facebook",
      "Include caption",
      "Photos of hate speech or symbols, such as swastikas or White Power hand signs",
      "Two-factor authentication",
      "When you follow hashtags, you'll see them here.",
      "Are you sure that you want to leave? Your video upload will be cancelled.",
      "Change Password",
      ...
      "County/region",
      "Current Browser",
      "The group won't know that it's been moved. You can move the group back to General at any time.",
      "Comments",
      "You have previously logged in to {application name} with Instagram.",
      "Collection name",
      "Switch Accounts",
      ...
      "Are you sure that you want to delete this video from your story?",
      "Facebook Company Products",
      "Share via Email",
      "Reach more people by making your videos visible on IGTV and your Facebook Page.",
      "Date of birth",
      "By allowing, {=app name} will receive ongoing access to your information, and Instagram will record when {=app name} accesses it. {=learn more} about this sharing and the settings that you have.",
      ...
      "Video has no sound",
      "Unfollow {username} so that you won't see any of their photos, videos or story in your feed.",
      "Skip",
      "Harassment or bullying",
      "Ask for Approval",
      ...
      "Emails from Instagram",
      "Cancel",
      "Your name will be shared with the organisation receiving your donation. Instagram will send updates to this email address.",
      "Category",
      ...
      "Please take a moment to review some changes to our {termsLink} and {dataPolicyLink}. Your Instagram experience isn't changing, and you still own your photos and videos. We are giving you better ways to access your data and understand how it's used. By continuing to use Instagram on or after 14 July 2018, you're agreeing to these updates.",
      "1 PLACE",
      "More posts from {UserLink}",
      "Upload failed. Only images can be posted.",
      "Age requirements",
      'Uploading "{videoTitle}"',
      "You won't be able to undo this. If you clear your search history, you may still see accounts that you've searched for as suggested results.",
      "Change phone number",
      "Continue in browser",
      "{Contact content owner text bolded} if you believe that you have the rights to use this content, contact {reference owner name} at {content owner email link}.",
      "Button: Select link type",
      "Incorrect password",
      "{filename} could not be uploaded. To continue, choose another file.",
      "Countries",
      "Live video",
      "The rights holder, {reference owner name}, rejected your dispute because they believe that the video contains their content.",
      "Delete all?",
      "Confirmation code",
      "Remove an account",
      "MM/YY",
      "9:16",
      "Tagged",
      "If you have permission to share everything in the video including the audio, such as the soundtrack or music, you can appeal the removal and have your video reposted.",
      "Profiles",
      "See this Instagram post by @{username}",
      "These business apps are third-party integrations with your business on Facebook that you've enabled. They can access information you choose to share with them and manage features for your Facebook business assets. Business apps maintain an ongoing connection with your business on Facebook. This business app (and those you have authorised to use it on your behalf) will be able to perform tasks until you choose to manually disconnect it.",
      "IGTV and Facebook Page",
      "Try logging in with your password. Once you've logged in, you can enable logging in across accounts in your Accounts Centre.",
      "User ID",
      "Temperature",
      "Follow @{username}?",
      ...
      "Voice",
      "Sign up to see photos and videos from friends and discover other accounts that you'll love.",
      "Month:",
      "Vignette",
      "Manage Facebook Pay",
      "Get Instagram App",
      ...
      "Use Instagram Lite",
      "Add Photo ID Icon",
      "How you receive authentication codes",
      "Only receive login help emails from devices on which you've used Instagram before. This setting will last for the next {days to snooze} days.",
      "Please explain why you believe that this content should not have been removed.",
      "Post was not uploaded.",
      "Message unavailable",
      "Something went wrong. Please try again.",
      ...
      "Copy link",
      "Female",
      "They requested photos containing this content to be blocked everywhere except for in the following countries in which they own the rights:",
      "Policies",
      ...
      "Sun",
      "th",
      "We remove posts that include copyright or trademark infringement. If someone is using your photos without your permission or impersonating you, we may also remove the content and disable the account. To learn more about reporting an intellectual property violation, visit our Help Centre.",
      ...
      "Enter password",
      "Trusted devices",
      "A verified badge is a tick that appears next to an Instagram account's name to indicate that the account is the authentic presence of a notable public figure, celebrity, global brand or entity that it represents.",
      "Not Now",
      ...
      "Deselect all",
      "Instagram's Terms of Service prohibit children under 13 from using the app. We investigate each report. Providing false information may lead to your account being suspended.",
      "Not Now",
      ...
      "Language",
      "Only people who {story owner username} has added to their close friends list can see this video.",
      "Find Facebook friends",
      "Confirm your PayPal login for",
      "Collections",
      "Edit",
      ...
      "Provide a safer experience for you and to analyse the use of our systems",
      "tapping Next",
      "Turning off two-factor authentication means that you won't need to enter a security code when you log in.",
      ...
      "Video sound on",
      "Accept Terms",
      "Make sure that you are signed in to this accidental second account in order to avoid deleting your main account. You are signed in as {username}. If this is incorrect, {first log out} and then log in with the correct account.",
      "Receive reminders about products in your shopping bag.",
      ...
      "Your login, {emailOrPhone}, is used for both Facebook and Instagram, but these aren't linked. Link your accounts to log in more easily.",
      ...
      "Try logging in with your password. Once you log in, you can enable logging in with accounts in your Accounts Centre.",
      ...
      "Posts and comments promoting the use of hard drugs.",
      "Messages",
      "Download APK",
      "Like",
      "video",
      ...
      "Related:",
      "Cancel",
      "This confirmation couldn't be undone. Please check your network settings and try again.",
      "Self-harm (eating disorder, cutting or suicidal content)",
      "Accessibility",
      "{hours} h",
      ...
      "View Collection",
      "Election pin icon",
      "We'll only use the information that you submit to determine whether your account meets our verification criteria.",
      "New message",
      ...
      "Blocked",
      "Discard video?",
      "We need to delete your account because you've said that you are younger than 13. You can {download_your_data} so you have a copy of what you've shared on Instagram.",
      ...
      "The issue, which started on 19 November 2018, caused your account's privacy setting to switch from private to public. We fixed the issue and restored your account to private on 20 November 2018. If new accounts followed you during that time, we've removed those followers.",
      ...
      "Seen by {username}",
      "Discover more free photos when you sign up.",
      "We'll now ask for a login code each time you log in on a phone or computer we don't recognise.",
      "Sorry, something went wrong while loading your info from Facebook. We're looking into it. In the meantime, you can sign up through the app, or try again later.",
      "Product unavailable",
      "Use {email suggestion} instead",
      "The security code that you entered doesn't match {cardName}",
      ...
      "Close",
      "This will be shared with {reference owner name} so that they may contact you about your appeal.",
      "Log In with Instagram",
      "Create a Message",
      ...
      "Your video will be blocked in all locations, which means that people won't be able to view, like or comment on it.",
      "1 m",
      "Firefox",
      "No",
      ...
      "• You can edit the information that {app name} will receive. You may choose to go back to exit without sharing, but you may not use Instagram to log in to {app name}.",
      ...
      "Switch to Instagram",
      "Let us know if you want to cancel this Gift Aid declaration, if your name or home address changes or if you no longer pay sufficient tax on your income or capital gains.",
      "You can block them at any time from their profile.",
      "Tagged accounts",
      "Continue",
      ...
      "Discard photo?",
      "By doing so, you'll authorise Facebook Pay to use your saved payment info for this and future payments on Instagram.",
      "Due to ownership restrictions, your video has been blocked in the following countries in which they own the rights:",
      "th",
      "They won't be able to find your profile, posts or story on Instagram. Instagram won't let them know that you've blocked them.",
      "Log In",
      ...
      "Posts",
      "Allow Instagram to use cookies and similar technologies on other apps and websites?",
      "You requested to delete {username}. If you want to keep it, you have until {date} to let us know. Otherwise, all of your posts and information will be deleted. {help center link}.",
      "Clear search history",
      ...
      "OK",
      "If you've made a mistake, you can appeal this decision to let us know.",
      ...
      "{Submit a dispute text bolded} if you have permission to use all of the content in your photo. By submitting a dispute, you give {reference owner name}, who has issued this claim, permission to review your photo. They can also review the entire post, if you've shared it publicly. They will have seven days to respond.",
      "Go to feed",
      ...
      "Photo",
      "Self-injury",
      "The video labelled {filename} is too long. To continue, choose a shorter video.",
      "Email address is invalid",
      "Add Profile Photo",
      "LEARN MORE",
      "We understand that you may be too busy to use Instagram and suggest removing the application from your phone using the following steps:",
      "Thanks! You've resubscribed to Instagram's research emails. We will include you in future feedback projects.",
      "Your contact info makes it easier for people to email, call or take an action from buttons that will appear on your profile. You can display or hide these at any time.",
      "N/A",
      "{username}'s profile picture",
      "Reels",
      "This is you!",
      ...
      "It looks like your account could be confused with another verified account. You need to add info to your profile so that people don't mistake you for the brand, celebrity or organisation that they're looking for.",
      "Added",
      ...
      "People you follow",
      "IGTV",
      'We work hard to protect the password that you use for your Instagram account. We\'ve recently discovered that when you used the "Download your data" tool, your password may have been displayed in the URL in your web browser once your data was downloaded, as well as being stored in our systems. We have now changed the tool so that this no longer happens, and we are deleting passwords that may have been logged by our internal systems. Nothing that we see suggests that anyone else used your password. Just to be safe, you may want to {link} on Instagram, as well as anywhere else where you use the same password. You may also want to clear your browser history.',
      ...
      "Upload failed.",
      "Discover",
      "We need to delete your account. You can download your data within the next 14 days so that you can have a copy of what you've shared on Instagram. You can also {appeal this decision}",
      "You can continue using Instagram to log in to other apps and websites",
      ...
      "Your account doesn't follow the Partner Monetisation Policies.",
      "Select from computer",
      ...
      "two right-facing rainbow coloured chevrons, indicating this product is supported for native checkout",
      "Your provider",
      ...
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. Our guidelines are based on our global community, and some audiences may be sensitive to different things.",
      "Turn this off?",
      "Save",
      "We monitor payments on Instagram to detect unauthorised activity.",
      "Limit password reset emails",
      ...
      "Symbols",
      "Videos must be between {minDurationInSeconds} and {maxDurationInMinutes} minutes long.",
      ...
      "Me",
      "warning icon",
      "You requested to delete {username}. If you want to keep it, you have until {date} to let us know. Otherwise, all of your posts and information will be deleted. {Learn More}",
      ...
      "Thank you",
      "Your name",
      "{Submit a dispute text bolded} if you have permission to use all of the content in your video. By submitting a dispute, you give {reference owner name}, who has issued this claim, permission to review your video. They can also review the entire post, if you've shared it publicly. They will have seven days to respond.",
      "Guide",
      "Find a location",
      "{amount} · {count}",
      "Uses less space. Free on Google Play.",
      ...
      "Report under CPA",
      "{duration} remaining",
      "Are you sure that you want to delete your contacts from Instagram?",
      "Allow All Cookies",
      "Dispute block",
      "hours",
      "See post",
      ...
      "Previous",
      "Because you are under 18, you will need to contact us to update your date of birth for Instagram",
      "Yes",
      "Delete post?",
      "It's a scam or it's misleading",
      "This conversation shouldn't be on Instagram",
      "Tags",
      "{Restore this video text bolded} if you think that this is a mistake and you have permission to use all of the content in your video. Your video will be posted as is.",
      "This means that we won't be able to review your post again, though your feedback helps us learn as we build tools to keep our community safe.",
      "When you follow people, you'll see the photos and videos that they post here.",
      "They will now be able to see your posts and follow you on Instagram. Instagram won't let them known that you've unblocked them.",
      "{Submit a dispute text bolded} if you have permission to use all of the content in your video. By submitting a dispute, you give {owner name}, who has issued this claim, permission to review your video. They can also review the entire post if you've shared it publicly. They will have {number of days} days to respond.",
      "Support",
      "Settings icon",
      ...
      "Your photo lets your friends know that it's you.",
      "Switch to {username}?",
      "Remove authentication app?",
      ...
      "Add File",
      "Create new post",
      "We weren't able to connect your account using the info that you provided. You can still enter your payment information to check out.",
      ...
      "Postcode",
      "Enter the 6-digit security code we've just sent you to verify your account.",
      "Send Email",
      "View map info",
      "Your privacy is very important to us and we're constantly working to ensure that issues like this don't occur. If you have any questions, please contact us at {email}.",
      ...
      "Your followers",
      "New post",
      "If you don't contact the content owner or remove your video, the block may be applied after {Date when the video block will go into effect}.",
      "Your story goes against our Community Guidelines",
      "Sign up",
      "See More Posts",
      "Enter your PIN again to confirm.",
      "send the code again",
      "For advertising and measurement services off Facebook Products, analytics, and to provide certain features and improve our services for you, we use tools from other companies. These companies also use cookies. You can learn more in our {Cookie Policy}.",
      "Finding notable accounts to follow",
      "{Learn more} about how you can use music on Instagram.",
      "Follow this account to see their photos and videos",
      "The file that you've selected is not supported.",
      "Please explain in detail why you believe that your dispute should've been approved.",
      "{count} view",
      ...
      "Post",
      "{count} views",
      "For offering opinions on a brand, celebrity or organisation",
      "Done",
      ...
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because violence can make some people feel unsafe on Instagram.",
      ...
      "Did you know that your VKontakte friend {full name of the contact who joined} is on Instagram as {username of the user who joined}?",
      "Cancel",
      "Try again",
      ...
      "Frequently used",
      "Ads interests",
      "We'll now ask for a login code any time you log in on a phone or computer that we don't recognise.",
      "1 minute ago",
      ...
      "Just one more step",
      "Turning this on means that we'll send you a security code when we need to confirm that it's you logging in.",
      "Follow Back",
      "Add a profile photo so that your friends know it's you.",
      "nd",
      "Gender",
      ...
      "Facebook Products",
      "Edit Profile",
      "The issue, which started on 5 April 2018, caused the privacy setting of your account to switch from private to public. We fixed the issue and restored your account to private on 9 April 2018. If new accounts followed you during that time, we removed those followers between 9 April and 10 April.",
      "Community Guidelines",
      "Town/city",
      "Cancel",
      "report",
      ...
      "This includes information that recognised organisations with local or international knowledge have told us could incite violence or cause physical harm off Instagram.",
      "{count} likes",
      "Report {username} for impersonating a celebrity?",
      "Because you've reported {The username of the account being reported}'s profile, we've also blocked the account.",
      "Broken link",
      "Comment {actionType}",
      "Edit ID Photo",
      "We weren't able to connect your account using the PIN that you entered. You can still connect by entering the security code for {cardName} that you used on Facebook.",
      "We have fewer reviewers available at the moment because of the coronavirus (COVID-19) outbreak. We're trying to prioritise reviewing content with the most potential for harm.",
      ...
      "Graphic injury, unlawful activity, dangerous or criminal organisations",
      "Quick Reactions",
      "The issue affected some Facebook and Instagram employees who had more than one Instagram account logged in on their device. Between 1 June 2018 and 5 June 2018, it caused some posts or stories published from one account to be posted to another account logged in on the same device. As a precaution, we encourage you to look at your profile and make sure that any posts from 1-5 June were shared from the intended account.",
      ...
      "New post",
      "When you log in and follow them, you'll see every post that they share.",
      "Profile completed",
      "Sent!",
      ...
      "All monetised videos must include previews. Previews appear in feed and on your profile.",
      ...
      "Feb",
      "You can't sign up for Instagram based on the information you've provided.",
      "{whatsapp business name}",
      "Hi {username},",
      "Explore",
      "Learn more",
      "Previews appear on your profile and in your feed",
      ...
      "We've started creating a file of things that you've shared on Instagram and will email a link to {email address}. It may take up to 48 hours to collect this data and send it to you.",
      "Delete Photo",
      "• Apps and websites may request access to the information that you've shared from Instagram. These requests are automatically logged by our systems and are not controlled by your device settings.",
      "Edit",
      "Video is too long",
      "The policy has more information about what we collect from your activity and our partners, how we connect information across the Facebook Companies and how we personalise your experience, including ads.",
      ...
      "Log In with Google",
      "Delete Comment",
      "• The connection allows the app or website to authenticate your account and receive information that you may choose to share, such as your photos.",
      "Business accounts",
      "Tagged people",
      ...
      "View Post",
      "We've sent the confirmation code to your number ending in {phone_number}",
      "Phone number",
      "API Terms of Use",
      "LIVE FUNDRAISER",
      ...
      "Delete Comment",
      "The link we sent to {email address} only worked for four days. You can request another copy of your data.",
      ...
      "If you remove {name}, it may delete your {name} account and activity. {name} may also still have access to information that you've previously shared, but can't make additional requests for private information.",
      ...
      "Next",
      "By submitting a dispute, you give the rights holder, {reference owner name}, permission to review your video and basic public information about your account. They will have seven days to respond.",
      ...
      "Your photo has been added.",
      "Your video doesn't meet the requirements. {Learn More}",
      "{Log in} to like this",
      ...
      "Review and agree",
      "Details of appeal",
      "INFO THAT YOU'RE SHARING WITH THIS APP",
      "Video glyph",
      ...
      "Notification sent",
      "• If you would like the information that we receive from apps and websites to only be shared with Instagram, remove your Instagram and Facebook accounts from {=accounts center}.",
      "Available on the App Store",
      "Cities in {country name}",
      "Forgotten password?",
      "Dismiss",
      "These messages are from people who you've restricted or don't follow. They won't know that you've viewed their request until you allow them to message you.",
      "Confirm new password",
      "Show less removed content",
      "Get Instagram Lite",
      "We receive different kinds of information from your device, such as how you tap and scroll, which can help distinguish humans from bots and detect fraud.",
      "Posts that contain credible threats",
      "We use cookies to help personalise content, serve relevant ads and provide a safer experience. Learn more about cookie uses and controls in our {Cookie Policy}. You can review your controls at any time.",
      "Think we've made a mistake?",
      "Now",
      "Sorry, something went wrong while creating your account. Please try again soon.",
      "Former bio texts",
      "th",
      "Trust this device",
      "Think that this is an unauthorised use of your intellectual property? {link_to_learn_how_to_report_it}",
      "Add extra security to your account",
      ...
      "Sorry! We're having trouble verifying your confirmation code at the moment. Please try again later.",
      ...
      "We've removed your {contentTypeText} because it goes against our {communityGuidelinesLink}. If you post something that goes against our guidelines again, your account will be deleted, including your posts, archive, messages and followers.",
      "Something went wrong",
      ...
      "Only receive password reset emails from devices on which you've used Instagram before. This setting will last for the next {days to snooze} days.",
      "Select Post Link",
      "th",
      "Preparing draft",
      "Forgotten PIN?",
      ...
      "We have fewer reviewers available at the moment and are trying hard to prioritise reports with the most potential for harm.",
      "You're all set!",
      "Learn more",
      "pm",
      "Enter code",
      "Settings",
      "The people listed here are contacts that you've uploaded to Instagram. To remove your synced contacts, tap Delete All. Your contacts will be re-uploaded the next time Instagram syncs your contacts unless you go to your device settings and turn off access to contacts.",
      "Username",
      ...
      "Cookies",
      "We use spam reports as a signal to understand problems we're having with spam on Instagram. If you think that this account violates our {link_to_instagram_community_guidelines} or {link_to_instagram_terms_of_use} and should be removed, mark it as inappropriate.",
      "Request not completed",
      "Close friends only",
      "Cancel",
      "Upon submission of an effective DMCA counter-notification, we will promptly forward it to the reporting party. If the reporting party does not notify us that they have filed an action seeking a court order to restrain you from engaging in infringing activity on Instagram related to the material in question within 10-14 working days, we will promptly restore eligible content under the DMCA. In rare instances, we may not be able to restore content due to technical limitations. In that event, we'll send you an update letting you know that you may repost the content to the site at your discretion. An effective DMCA counter-notification must contain your name, address and telephone number, among other information, and the party who reported your content can use that information to assist them in filing an action against you in court. This means that Instagram is required to pass the contact information that you provide in the counter-notification to the reporting party. Restored content will not be counted against you if your account is ever reviewed for potentially violating our policies on repeat infringement.",
      "Product emails",
      "Instagram",
      "Get the Instagram app",
      "Log in to continue",
      "Drop-down icon for country selector",
      "{count} Request",
